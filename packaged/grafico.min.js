var Grafico={Base:{},Normaliser:{},SparkLine:{},SparkBar:{},BaseGraph:{},LineGraph:{},AreaGraph:{},StackGraph:{},BarGraph:{},HorizontalBarGraph:{}};Grafico.Base=Class.create({normaliseData:function(a){return $A(a).collect(function(b){return this.normalise(b)}.bind(this))},deepCopy:function(a){var b,c,d;if(Object.prototype.toString.call(a)==="[object Array]"){b=[];d=a.length;for(c=0;c<d;c++)b[c]=arguments.callee(a[c]);return b}if(typeof a==="object"){b={};for(c in a)b[c]=arguments.callee(a[c]);return b}return a}});
...
f.push([f[f.length-1][0],h])}else j=this.paper.path().attr({stroke:b,"stroke-width":this.options.stroke_width+"px"});this.options.datalabels&&this.drawHover(j,d,e,b);$A(f).each(function(l,m){this.drawPlot(m,j,l[0],l[1],b,f,d,e,g)}.bind(this));if(this.options.area&&this.options.stroke_width>0){i=this.paper.path().attr({stroke:b,"stroke-width":this.options.stroke_width+"px"});f.remove(0);f.remove(-1);$A(f).each(function(l,m){this.drawPlot(m,i,l[0],l[1],b,f,d,e,g,true)}.bind(this));this.globalAreaLineSet.push(i)}},
...
this.paper.path().attr(this.options.meanline);a=$A(a).inject(0,function(c,d){return d+c})/a.length-0.5;a=this.options.bar?a+this.zero_value*(this.graph_height/this.y_label_count):a;b.moveTo(this.x_padding_left-1,this.options.height-this.y_padding_bottom-a).lineTo(this.graph_width+this.x_padding_left,this.options.height-this.y_padding_bottom-a)},drawAxis:function(){var a=this.paper.path().attr({stroke:this.options.label_colour});a.moveTo(parseInt(this.x_padding_left,10)-0.5,this.options.height-parseInt(this.y_padding_bottom,
10)+0.5);a.lineTo(parseInt(this.graph_width+this.x_padding_left,10)-0.5,this.options.height-parseInt(this.y_padding_bottom,10)+0.5);a.moveTo(parseInt(this.x_padding_left,10)-0.5,parseInt(this.options.height-this.y_padding_bottom,10)+0.5);a.lineTo(parseInt(this.x_padding_left,10)-0.5,parseInt(this.y_padding_top,10))},makeValueLabels:function(a){for(var b=this.label_step,c=this.start_value,d=[],e=0;e<a;e++){c=this.roundValue(c+b,3);d.push(c)}return d},drawMarkers:function(a,b,c,d,e,g){function f(m){return m*
b[0]}function h(m){return m*b[1]}var j=parseInt(this.x_padding_left,10)-0.5+f(d),i=this.options.height-this.y_padding_bottom+h(d),k=this.paper.path().attr({stroke:this.options.label_colour}),l={font:this.options.font_size+'px "Arial"',stroke:"none",fill:this.options.label_colour};Object.extend(l,g||{});a.each(function(m){if(this.options.draw_axis&&(this.options.hide_empty_label_grid===true&&m!==""||this.options.hide_empty_label_grid===false)){k.moveTo(parseInt(j,10),parseInt(i,10)+0.5);k.lineTo(parseInt(j,
10)+h(5),parseInt(i,10)+0.5+f(5))}this.paper.text(j+e[0],i-2-e[1],m.toString()).attr(l).toFront();j+=f(c);i+=h(c)}.bind(this))},drawVerticalLabels:function(){for(var a=this.graph_height/this.y_label_count,b=this.options.vertical_label_unit?" "+this.options.vertical_label_unit:"",c=0;c<this.value_labels.length;c++)this.value_labels[c]+=b;this.drawMarkers(this.value_labels,[0,-1],a,a,[-8,-2],{"text-anchor":"end"})},drawHorizontalLabels:function(){this.drawMarkers(this.options.labels,[1,0],this.step,
this.options.plot_padding,[0,(this.options.font_size+7)*-1],this.options.label_rotation?{rotation:this.options.label_rotation,translation:-this.options.font_size+" 0"}:{})},drawHover:function(a,b,c,d){var e=this.options.stacked_fill||this.options.area?"fill":"stroke",g=this.options.hover_colour||d,f=this.paper.set();b=this.paper.text(a.attrs.x,a.attrs.y-this.options.font_size*1.5-4,b).attr({"font-size":this.options.font_size,fill:this.options.hover_text_colour,opacity:1});var h=b.getBBox(),j=this.drawRoundRect(b,
...
h.width/2-4-c.offsetLeft,y:k.y-h.height/2-this.options.font_size*1.5-4-c.offsetTop,opacity:1});f[1].attr({x:k.x-c.offsetLeft,y:k.y-this.options.font_size*1.5-c.offsetTop,opacity:1});this.checkHoverPos(j,f)}.bind(this)}.bind(this);a.node.onmouseout=function(){e==="fill"?a.animate({fill:d,stroke:d},200):a.animate({stroke:d},200);f.attr({opacity:0})}},checkHoverPos:function(a){var b,c,d,e,g,f;if(a.rect){b=a.rect;c=b.getBBox()}if(a.set)d=a.set;if(a.marker)e=a.marker;if(a.nib)g=a.nib;if(a.textpadding)f=
a.textpadding;if(b&&d){if(b.attrs.y<0)if(g&&e){d.translate(0,d.getBBox().height+f*2);e.translate(0,-d.getBBox().height-f*2);g.translate(0,-c.height-f+1.5).scale(1,-1)}else{a=b.attrs.y;d.translate(0,1+a*-1)}if(b.attrs.y+c.height>this.options.height){a=b.attrs.y+c.height-this.options.height;d.translate(0,a*-1-1);e&&e.translate(0,a+1)}if(b.attrs.x<0){a=b.attrs.x;d.translate(a*-1+1,0);g&&g.translate(a-1,0);e&&e.translate(a-1,0)}if(b.attrs.x+c.width>this.options.width){a=b.attrs.x+c.width-this.options.width;
d.translate(a*-1-1,0);g&&g.translate(a+1,0);e&&e.translate(a+1,0)}}},drawNib:function(a,b,c){return this.paper.path().attr({fill:this.options.label_colour,opacity:1,stroke:this.options.label_colour,"stroke-width":"1px"}).moveTo(a.attrs.x-c,a.attrs.y+b.height/2+c-1.5).lineTo(a.attrs.x,a.attrs.y+b.height/2+c*2-1.5).lineTo(a.attrs.x+c,a.attrs.y+b.height/2+c-1.5).andClose()},drawRoundRect:function(a,b,c){return this.paper.rect(a.attrs.x-b.width/2-c,a.attrs.y-b.height/2-c,b.width+c*2,b.height+c*2,c*1.5).attr({fill:this.options.label_colour,
opacity:1,stroke:this.options.label_colour,"stroke-width":0})}});Array.prototype.sum=function(){for(var a=0,b=0;a<this.length;b+=this[a++]);return b};if(typeof Array.prototype.max==="undefined")Array.prototype.max=function(){return Math.max.apply({},this)};if(typeof Array.prototype.min==="undefined")Array.prototype.min=function(){return Math.min.apply({},this)};Array.prototype.mean=function(){return this.sum()/this.length};
...
c-this.graph_height/18:c-this.graph_height/6,j=this.step,i=this.options.stacked?this.graph_height/9:this.graph_height/3;b=this.paper.circle(b,c,this.options.marker_size);c=this.paper.rect(f,h,j,i);b.attr({"stroke-width":"1px",stroke:this.options.background_colour,fill:d,opacity:0});c.attr({fill:d,"stroke-width":0,stroke:d,opacity:0}).toFront();e=this.options.datalabels?e+": "+g:g.toString();e+=this.options.vertical_label_unit?" "+this.options.vertical_label_unit:"";var k=this.paper.set();d=this.paper.text(b.attrs.cx,
b.attrs.cy-this.options.font_size*1.5-8,e).attr({"font-size":this.options.font_size,fill:this.options.hover_text_colour,opacity:1});g=d.getBBox();e=this.drawRoundRect(d,g,4);g=this.drawNib(d,g,4);d.toFront();k.push(b,e,g,d).attr({opacity:0}).toFront();this.checkHoverPos({rect:e,set:k,marker:b,nib:g,textpadding:4});this.globalHoverSet.push(k);this.globalBlockSet.push(c);c.node.onmouseover=function(){k.animate({opacity:1},200)};c.node.onmouseout=function(){k.animate({opacity:0},200)}}}});
...
a.node.onmouseover=function(){c.animate({fill:g,stroke:g},200);f.animate({opacity:1},200)}.bind(this);a.node.onmouseout=function(){c.animate({fill:e,stroke:e},200);f.animate({opacity:0},200)}}});
...
this.paper.path().attr({stroke:a,"stroke-width":this.options.stroke_width}).moveTo(0,this.options.height-b.first()),d=0,e=this.data.min()<0?this.options.stroke_width:0;b.slice(1).each(function(g){d+=this.step;c.lineTo(d,this.options.height-g-e)}.bind(this))},showHighlight:function(a){var b=1+this.options.stroke_width/2,c=this.options.width-b;a=a[this.options.highlight.index||a.length-1]+(b/2).round();var d=this.options.highlight.colour||"#f00";if(typeof this.options.highlight.index!=="undefined")c=
