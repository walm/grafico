...
this.options.area_opacity:1.5/this.data_sets.collect(function(l){return l.length}).length;j=this.paper.path().attr({stroke:b,fill:b,"stroke-width":"0",opacity:a,"stroke-opacity":0})}else j=this.paper.path().attr({stroke:b,fill:b,"stroke-width":"0"});g.unshift([g[0][0],h]);g.push([g[g.length-1][0],h])}else j=this.paper.path().attr({stroke:b,"stroke-width":this.options.stroke_width+"px"});$A(g).each(function(l,m){this.drawPlot(m,j,l[0],l[1],b,g,d,e,f)}.bind(this));if(this.options.area&&this.options.stroke_width>
0){i=this.paper.path().attr({stroke:b,"stroke-width":this.options.stroke_width+"px"});g.remove(0);g.remove(-1);$A(g).each(function(l,m){this.drawPlot(m,i,l[0],l[1],b,g,d,e,f,true)}.bind(this));this.globalAreaLineSet.push(i)}if(this.options.datalabels){this.drawHover(j,d,e,b);this.globalHoverSet.toFront()}},calculateCoords:function(a){var b=this.x_padding_left+this.options.plot_padding-this.step,c=this.graph_height+this.y_padding_top+this.normalise(this.start_value);return $A(a).collect(function(d){d=
c-d;b+=this.step;return[b,d]}.bind(this))},drawFocusHint:function(){var a=this.x_padding_left+2.5-1,b=this.options.height-this.y_padding_bottom,c=this.paper.path().attr({stroke:this.options.label_color,"stroke-width":2});c.moveTo(a,b);c.lineTo(a-5,b-5);c.moveTo(a,b-5);c.lineTo(a-5,b-10)},drawMeanLine:function(a){var b=this.paper.path().attr(this.options.meanline);a=$A(a).inject(0,function(c,d){return d+c})/a.length-0.5;a=this.options.bar?a+this.zero_value*(this.graph_height/this.y_label_count):a;
b.moveTo(this.x_padding_left-1,this.options.height-this.y_padding_bottom-a).lineTo(this.graph_width+this.x_padding_left,this.options.height-this.y_padding_bottom-a)},drawAxis:function(){var a=this.paper.path().attr({stroke:this.options.label_color});a.moveTo(parseInt(this.x_padding_left,10)-0.5,this.options.height-parseInt(this.y_padding_bottom,10)+0.5);a.lineTo(parseInt(this.graph_width+this.x_padding_left,10)-0.5,this.options.height-parseInt(this.y_padding_bottom,10)+0.5);a.moveTo(parseInt(this.x_padding_left,
10)-0.5,parseInt(this.options.height-this.y_padding_bottom,10)+0.5);a.lineTo(parseInt(this.x_padding_left,10)-0.5,parseInt(this.y_padding_top,10))},makeValueLabels:function(a){for(var b=this.label_step,c=this.start_value,d=[],e=0;e<a;e++){c=this.roundValue(c+b,3);d.push(c)}return d},drawMarkers:function(a,b,c,d,e,f){function g(m){return m*b[0]}function h(m){return m*b[1]}var j=parseInt(this.x_padding_left,10)-0.5+g(d),i=this.options.height-this.y_padding_bottom+h(d),k=this.paper.path().attr({stroke:this.options.label_color}),
l={font:this.options.font_size+'px "Arial"',stroke:"none",fill:this.options.label_color};Object.extend(l,f||{});a.each(function(m){if(this.options.draw_axis&&(this.options.hide_empty_label_grid===true&&m!==""||this.options.hide_empty_label_grid===false)){k.moveTo(parseInt(j,10),parseInt(i,10)+0.5);k.lineTo(parseInt(j,10)+h(5),parseInt(i,10)+0.5+g(5))}this.paper.text(j+e[0],i-2-e[1],m.toString()).attr(l);j+=g(c);i+=h(c)}.bind(this))},drawVerticalLabels:function(){for(var a=this.graph_height/this.y_label_count,
b=this.options.vertical_label_unit?" "+this.options.vertical_label_unit:"",c=0;c<this.value_labels.length;c++)this.value_labels[c]+=b;this.drawMarkers(this.value_labels,[0,-1],a,a,[-8,-2],{"text-anchor":"end"})},drawHorizontalLabels:function(){var a=this.options.label_rotation?{rotation:this.options.label_rotation,translation:-this.options.font_size+" 0"}:{},b=this.options.labels;if(this.options.label_max_size)for(var c=0;c<b.length;c++)b[c]=b[c].truncate(this.options.label_max_size+1,"\u2026");this.drawMarkers(b,
[1,0],this.step,this.options.plot_padding,[0,(this.options.font_size+7)*-1],a)},drawHover:function(a,b,c,d){var e=this.options.stacked_fill||this.options.area?"fill":"stroke",f=this.options.hover_color||d,g=this.paper.set();b=this.paper.text(a.attrs.x,a.attrs.y-this.options.font_size*1.5-4,b).attr({"font-size":this.options.font_size,fill:this.options.hover_text_color,opacity:1});var h=b.getBBox(),j=this.drawRoundRect(b,h,4);g.push(j,b).attr({opacity:0});this.checkHoverPos({rect:j,set:g});this.globalHoverSet.push(g);
a.node.onmouseover=function(i){e==="fill"?a.animate({fill:f,stroke:f},200):a.animate({stroke:f},200);i=this.getMousePos(i);g[0].attr({x:i.x-h.width/2-4-c.offsetLeft,y:i.y-h.height/2-this.options.font_size*1.5-4-c.offsetTop,opacity:1});g[1].attr({x:i.x-c.offsetLeft,y:i.y-this.options.font_size*1.5-c.offsetTop,opacity:1});a.node.onmousemove=function(k){k=this.getMousePos(k);g[0].attr({x:k.x-h.width/2-4-c.offsetLeft,y:k.y-h.height/2-this.options.font_size*1.5-4-c.offsetTop,opacity:1});g[1].attr({x:k.x-
c.offsetLeft,y:k.y-this.options.font_size*1.5-c.offsetTop,opacity:1});this.checkHoverPos(j,g)}.bind(this)}.bind(this);a.node.onmouseout=function(){e==="fill"?a.animate({fill:d,stroke:d},200):a.animate({stroke:d},200);g.attr({opacity:0})}},checkHoverPos:function(a){var b,c,d,e,f,g;if(a.rect){b=a.rect;c=b.getBBox()}if(a.set){d=a.set;setbox=d.getBBox()}if(a.marker)e=a.marker;if(a.nib)f=a.nib;if(a.textpadding)g=a.textpadding;if(b&&d){if(b.attrs.y<0)if(f&&e){d.translate(0,setbox.height+g*2);e.translate(0,
-setbox.height-g*2);f.translate(0,-c.height-g+1.5).scale(1,-1)}else{a=b.attrs.y;d.translate(0,1+a*-1)}if(b.attrs.y+c.height>this.options.height){a=b.attrs.y+c.height-this.options.height;d.translate(0,a*-1-1);e&&e.translate(0,a+1)}if(b.attrs.x<0){a=b.attrs.x;d.translate(a*-1+1,0);f&&f.translate(a-1,0);e&&e.translate(a-1,0)}if(b.attrs.x+c.width>this.options.width){a=b.attrs.x+c.width-this.options.width;d.translate(a*-1-1,0);f&&f.translate(a+1,0);e&&e.translate(a+1,0)}}},drawNib:function(a,b,c){return this.paper.path().attr({fill:this.options.label_color,
...
c-this.graph_height/18:c-this.graph_height/6,j=this.step,i=this.options.stacked?this.graph_height/9:this.graph_height/3;b=this.paper.circle(b,c,this.options.marker_size);c=this.paper.rect(g,h,j,i);b.attr({"stroke-width":"1px",stroke:this.options.background_color,fill:d,opacity:0});c.attr({fill:d,"stroke-width":0,stroke:d,opacity:0});e=this.options.datalabels?e+": "+f:f.toString();e+=this.options.vertical_label_unit?" "+this.options.vertical_label_unit:"";var k=this.paper.set();d=this.paper.text(b.attrs.cx,
b.attrs.cy-this.options.font_size*1.5-8,e).attr({"font-size":this.options.font_size,fill:this.options.hover_text_color,opacity:1});f=d.getBBox();e=this.drawRoundRect(d,f,4);f=this.drawNib(d,f,4);k.push(b,e,f,d).attr({opacity:0});this.checkHoverPos({rect:e,set:k,marker:b,nib:f,textpadding:4});this.globalHoverSet.push(k);this.globalBlockSet.push(c);c.node.onmouseover=function(){k.animate({opacity:1},200)};c.node.onmouseout=function(){k.animate({opacity:0},200)}}}});
...
b.getBBox();d=this.drawRoundRect(b,h,4);h=this.drawNib(b,h,4);g.push(d,h,b).attr({opacity:0});this.checkHoverPos({rect:d,set:g,nib:h});this.globalHoverSet.push(g);this.globalBlockSet.push(a);d.attrs.y<0&&g.translate(0,1+d.attrs.y*-1);a.node.onmouseover=function(){c.animate({fill:f,stroke:f},200);g.animate({opacity:1},200)}.bind(this);a.node.onmouseout=function(){c.animate({fill:e,stroke:e},200);g.animate({opacity:0},200)}}});
...
g=this.x_padding_left+f-0.5,h=this.options.bargraph_lastcolor,j=this.options.bargraph_negativecolor;this.datalabel=d;$A(c).each(function(i,k){var l,m=this.options.horizontal_rounded?this.bar_width/2:0,n;l=h&&k===c.length-1?h:i<0?j:b;i=i/this.graph_width*(this.graph_width-f);n=this.paper.rect(g,e,i,this.bar_width,m).attr({fill:l,"stroke-width":0,stroke:l});i<0&&n.attr({width:-n.attrs.width}).translate(i,0);if(m){var p=this.paper.set();bargraph2=this.paper.rect(g,e,i-this.bar_width/2,this.bar_width);
bargraph2.attr({fill:l,"stroke-width":0,stroke:l});p.push(bargraph2,n);i<0&&bargraph2.attr({width:-bargraph2.attrs.width-this.bar_width}).translate(i+this.bar_width/2,0)}if(this.options.datalabels){var q=this.options.hover_color||l,o=this.paper.set();k=this.datalabel[k].toString();text=this.paper.text(f+i+this.x_padding_left/2,n.attrs.y-this.options.font_size*1.5,k).attr({"font-size":this.options.font_size,fill:this.options.hover_text_color,opacity:1});hoverbar=this.paper.rect(this.x_padding_left,
