...
10),this.y_padding_top);a.lineTo(parseInt(b,10),this.y_padding_top+this.graph_height)}b+=this.step}},drawLines:function(a,b,c,d,e,f){var g=this.calculateCoords(c),h=this.graph_height+this.y_padding_top,i,j,l;if(this.options.start_at_zero===false){l=0;$A(g).each(function(k){k[1]===h&&l++});this.options.odd_horizontal_offset=l;this.options.odd_horizontal_offset>1&&g.splice(0,this.options.odd_horizontal_offset)}if(this.options.stacked_fill||this.options.area){if(this.options.area){a=this.options.area_opacity?
this.options.area_opacity:1.5/this.data_sets.collect(function(k){return k.length}).length;i=this.paper.path().attr({stroke:b,fill:b,"stroke-width":"0",opacity:a,"stroke-opacity":0})}else i=this.paper.path().attr({stroke:b,fill:b,"stroke-width":"0"});g.unshift([g[0][0],h]);g.push([g[g.length-1][0],h])}else i=this.paper.path().attr({stroke:b,"stroke-width":this.options.stroke_width+"px"});$A(g).each(function(k,m){this.drawPlot(m,i,k[0],k[1],b,g,d,e,f)}.bind(this));if(this.options.area&&this.options.stroke_width>
0){j=this.paper.path().attr({stroke:b,"stroke-width":this.options.stroke_width+"px"});g.remove(0);g.remove(-1);$A(g).each(function(k,m){this.drawPlot(m,j,k[0],k[1],b,g,d,e,f,true)}.bind(this));this.globalAreaLineSet.push(j)}if(this.options.datalabels&&this.options.draw_hovers){this.drawHover(i,d,e,b);this.globalHoverSet.toFront()}},calculateCoords:function(a){var b=this.x_padding_left+this.options.plot_padding-this.step,c=this.graph_height+this.y_padding_top+this.normalise(this.start_value);return $A(a).collect(function(d){d=
...
10)-0.5,parseInt(this.options.height-this.y_padding_bottom,10)+0.5);a.lineTo(parseInt(this.x_padding_left,10)-0.5,parseInt(this.y_padding_top,10))},makeValueLabels:function(a){for(var b=this.label_step,c=this.start_value,d=[],e=0;e<a;e++){c=this.roundValue(c+b,3);d.push(c)}return d},drawMarkers:function(a,b,c,d,e,f){function g(m){return m*b[0]}function h(m){return m*b[1]}var i=parseInt(this.x_padding_left,10)-0.5+g(d),j=this.options.height-this.y_padding_bottom+h(d),l=this.paper.path().attr({stroke:this.options.label_color}),
k={font:this.options.font_size+'px "Arial"',stroke:"none",fill:this.options.label_color};Object.extend(k,f||{});a.each(function(m){if(this.options.draw_axis&&(this.options.hide_empty_label_grid===true&&m!==""||this.options.hide_empty_label_grid===false)){l.moveTo(parseInt(i,10),parseInt(j,10)+0.5);l.lineTo(parseInt(i,10)+h(5),parseInt(j,10)+0.5+g(5))}this.paper.text(i+e[0],j-2-e[1],m.toString()).attr(k);i+=g(c);j+=h(c)}.bind(this))},drawVerticalLabels:function(){for(var a=this.graph_height/this.y_label_count,
...
[1,0],this.step,this.options.plot_padding,[0,(this.options.font_size+7)*-1],a)},drawHover:function(a,b,c,d){var e=this,f=this.options.stacked_fill||this.options.area?"fill":"stroke",g=this.options.hover_color||d,h=this.paper.set();b=this.paper.text(a.attrs.x,a.attrs.y-this.options.font_size*1.5-4,b).attr({"font-size":this.options.font_size,fill:this.options.hover_text_color,opacity:1});var i=b.getBBox(),j=this.drawRoundRect(b,i,4);h.push(j,b).attr({opacity:0});this.checkHoverPos({rect:j,set:h});this.globalHoverSet.push(h);
a.hover(function(l){f==="fill"?a.animate({fill:g,stroke:g},200):a.animate({stroke:g},200);l=e.getMousePos(l);h[0].attr({x:l.x-i.width/2-4-c.offsetLeft,y:l.y-i.height/2-e.options.font_size*1.5-4-c.offsetTop,opacity:1});h[1].attr({x:l.x-c.offsetLeft,y:l.y-e.options.font_size*1.5-c.offsetTop,opacity:1});a.mousemove(function(k){k=e.getMousePos(k);h[0].attr({x:k.x-i.width/2-4-c.offsetLeft,y:k.y-i.height/2-e.options.font_size*1.5-4-c.offsetTop,opacity:1});h[1].attr({x:k.x-c.offsetLeft,y:k.y-e.options.font_size*
1.5-c.offsetTop,opacity:1});e.checkHoverPos(j,h)})},function(){f==="fill"?a.animate({fill:d,stroke:d},200):a.animate({stroke:d},200);h.attr({opacity:0})})},checkHoverPos:function(a){var b,c,d,e,f,g;if(a.rect){c=a.rect;d=c.getBBox()}if(a.set)e=a.set;if(a.marker)f=a.marker;if(a.nib)g=a.nib;if(a.textpadding)b=a.textpadding;if(c&&e){if(c.attrs.y<0)if(g&&f){a=e.getBBox();e.translate(0,a.height+b*2);f.translate(0,-a.height-b*2);g.translate(0,-d.height-b+1.5).scale(1,-1)}else{b=c.attrs.y;e.translate(0,1+
b*-1)}if(c.attrs.y+d.height>this.options.height){b=c.attrs.y+d.height-this.options.height;e.translate(0,b*-1-1);f&&f.translate(0,b+1)}if(c.attrs.x<0){b=c.attrs.x;e.translate(b*-1+1,0);g&&g.translate(b-1,0);f&&f.translate(b-1,0)}if(c.attrs.x+d.width>this.options.width){b=c.attrs.x+d.width-this.options.width;e.translate(b*-1-1,0);g&&g.translate(b+1,0);f&&f.translate(b+1,0)}}},drawNib:function(a,b,c){return this.paper.path().attr({fill:this.options.label_color,opacity:1,stroke:this.options.label_color,
"stroke-width":"0px"}).moveTo(a.attrs.x-c,a.attrs.y+b.height/2+c-1).lineTo(a.attrs.x,a.attrs.y+b.height/2+c*2).lineTo(a.attrs.x+c,a.attrs.y+b.height/2+c-1).andClose()},drawRoundRect:function(a,b,c){return this.paper.rect(a.attrs.x-b.width/2-c,a.attrs.y-b.height/2-c,b.width+c*2,b.height+c*2,c*1.5).attr({fill:this.options.label_color,opacity:1,stroke:this.options.label_color,"stroke-width":"0px"})}});Array.prototype.sum=function(){for(var a=0,b=0;a<this.length;b+=this[a++]);return b};
...
b,c,d,e,f,g){f=(this.options.stacked?this.real_data:this.data_sets).collect(function(k){return k[1][a]})[g];a+=this.options.odd_horizontal_offset>1?this.options.odd_horizontal_offset:0;a-=this.options.stacked_fill||this.options.area?1:0;if(f){f=""+f.toString().split(".");if(f[1])f[1]=f[1].truncate(3,"")}if(this.options.line||this.options.stacked||(this.options.stacked_fill||this.options.area)&&a!=-1&&typeof f!="undefined"){g=b-this.step/2;var h=this.options.stacked?c-this.graph_height/18:c-this.graph_height/
6,i=this.step,j=this.options.stacked?this.graph_height/9:this.graph_height/3;b=this.paper.circle(b,c,this.options.marker_size).attr({"stroke-width":"1px",stroke:this.options.background_color,fill:d,opacity:0});d=this.paper.rect(g,h,i,j).attr({fill:d,"stroke-width":0,stroke:d,opacity:0});e=this.options.datalabels?e+": "+f:""+f;e+=this.options.vertical_label_unit?" "+this.options.vertical_label_unit:"";var l=this.paper.set();e=this.paper.text(b.attrs.cx,b.attrs.cy-this.options.font_size*1.5-8,e).attr({"font-size":this.options.font_size,
...
Grafico.AreaGraph=Class.create(Grafico.LineGraph,{chartDefaults:function(){return{area:true,area_opacity:false,stroke_width:0}},setChartSpecificOptions:function(){if(typeof this.options.curve_amount==="undefined")this.options.curve_amount=10},drawPlot:function(a,b,c,d,e,f,g,h,i,j){var l=this.options.area||this.options.stacked_fill;if(!j)if(l===true){if(a!==0&&a!==f.length-1)if(this.options.markers==="circle")this.drawGraphMarkers(a,c,d,e,g,h);else this.options.markers==="value"&&this.drawGraphValueMarkers(a,
c,d,e,g,h,i)}else if(this.options.markers==="circle")this.drawGraphMarkers(a,c,d,e,g,h);else this.options.markers==="value"&&this.drawGraphValueMarkers(a,c,d,e,g,h,i);c-=0.5;if(a===0)return this.startPlot(b,c,d,e);if(this.options.curve_amount&&a>1&&a<f.length-1)b.cplineTo(c,d,this.options.curve_amount);else this.options.curve_amount&&!l&&1?b.cplineTo(c,d,this.options.curve_amount):b.lineTo(c,d)}});
Grafico.StackGraph=Class.create(Grafico.AreaGraph,{chartDefaults:function(){return{stacked:true,stacked_fill:true,stroke_width:0}},normaliserOptions:function(){},stackData:function(a){this.stacked_data=a.collect(function(c){return c[1]});this.stacked_data.reverse();for(a=1;a<this.stacked_data.length;a++)for(var b=0;b<this.stacked_data[0].length;b++)this.stacked_data[a][b]+=this.stacked_data[a-1][b];this.stacked_data.reverse();return this.stacked_data}});
...
g=this.x_padding_left+f-0.5,h=this.options.bargraph_lastcolor,i=this.options.bargraph_negativecolor;this.datalabel=d;$A(c).each(function(j,l){var k,m=this.options.horizontal_rounded?this.bar_width/2:0,n;k=h&&l===c.length-1?h:j<0?i:b;j=j/this.graph_width*(this.graph_width-f);n=this.paper.rect(g,e,j,this.bar_width,m).attr({fill:k,"stroke-width":0,stroke:k});j<0&&n.attr({width:-n.attrs.width}).translate(j,0);if(m){var p=this.paper.set();bargraph2=this.paper.rect(g,e,j-this.bar_width/2,this.bar_width);
bargraph2.attr({fill:k,"stroke-width":0,stroke:k});p.push(bargraph2,n);j<0&&bargraph2.attr({width:-bargraph2.attrs.width-this.bar_width}).translate(j+this.bar_width/2,0)}if(this.options.datalabels){var q=this.options.hover_color||k,o=this.paper.set();l=this.datalabel[l].toString();text=this.paper.text(f+j+this.x_padding_left/2,n.attrs.y-this.options.font_size*1.5,l).attr({"font-size":this.options.font_size,fill:this.options.hover_text_color,opacity:1});hoverbar=this.paper.rect(this.x_padding_left,
