var Grafico={Version:"1.0",Base:{},BaseGraph:{},Normaliser:{},LineGraph:{},AreaGraph:{},StackGraph:{},BarGraph:{},HorizontalBarGraph:{},SparkLine:{},SparkBar:{}},Ico=Grafico;
...
Grafico.Normaliser=Class.create({initialize:function(a,b){this.options={start_value:null};Object.extend(this.options,b||{});this.min=a.min();this.max=a.max();this.standard_deviation=a.standard_deviation();this.range=0;this.step=(this.same_values=this.min==this.max)?this.labelStep(Math.abs(this.min)):this.labelStep(this.max-this.min);this.start_value=this.calculateStart();this.process()},calculateStart:function(){var a=this.options.start_value!==null&&this.min>=0?this.options.start_value:this.min;
...
drawLinesInit:function(a){a.data_sets.each(function(b,c){a.drawLines(b[0],a.options.colours[b[0]],a.normaliseData(b[1]),a.options.datalabels[b[0]],a.element,c)}.bind(a))},drawWatermark:function(){if(this.options.watermark=="wakoopa")this.drawWakoopaWatermark(this,this.data);else{var a=this.options.watermark,b=new Image,c=this;b.onload=function(){var d,e;if(c.options.watermark_location=="middle"){d=(c.graph_width-b.width)/2+c.x_padding_left;e=(c.graph_height-b.height)/2+c.y_padding_top}else{d=c.graph_width-
...
c-this.graph_height/18:c-this.graph_height/6,j=this.step,i=this.options.stacked?this.graph_height/9:this.graph_height/3;b=this.paper.circle(b,c,this.options.marker_size);c=this.paper.rect(g,h,j,i);b.attr({"stroke-width":"1px",stroke:this.options.background_colour,fill:d,opacity:0});c.attr({fill:d,"stroke-width":0,stroke:d,opacity:0}).toFront();e=this.options.datalabels?e+": "+f:f.toString();e+=this.options.vertical_label_unit?" "+this.options.vertical_label_unit:"";var k=this.paper.set();d=this.paper.text(b.attrs.cx,
b.attrs.cy-this.options.font_size*1.5-8,e).attr({"font-size":this.options.font_size,fill:this.options.hover_text_colour,opacity:1});f=d.getBBox();e=this.drawRoundRect(d,f,4);f=this.drawNib(d,f,4);d.toFront();k.push(b,e,f,d).attr({opacity:0}).toFront();this.checkHoverPos({rect:e,set:k,marker:b,nib:f,textpadding:4});this.globalHoverSet.push(k);this.globalBlockSet.push(c);c.node.onmouseover=function(){k.animate({opacity:1},200)};c.node.onmouseout=function(){k.animate({opacity:0},200)}}}});
...
bargraph2.attr({fill:l,"stroke-width":0,stroke:l});n.toFront();p.push(bargraph2,n);i<0&&bargraph2.attr({width:-bargraph2.attrs.width-this.bar_width}).translate(i+this.bar_width/2,0)}if(this.options.datalabels){var q=this.options.hover_colour||l,o=this.paper.set();m=this.paper.rect(this.x_padding_left,e,this.graph_width,this.bar_width);d=this.datalabel[k].toString();k=this.paper.text(f+i+this.x_padding_left/2,n.attrs.y-this.options.font_size*1.5,d);m.attr({fill:l,"stroke-width":0,stroke:l,opacity:0});
k.attr({"font-size":this.options.font_size,fill:this.options.hover_text_colour,opacity:1});i<0&&k.translate(k.getBBox().width,0);n=k.getBBox();i=this.drawRoundRect(k,n,4);n=this.drawNib(k,n,4);k.toFront();o.push(i,n,k).attr({opacity:0}).toFront();m.toFront();this.checkHoverPos({rect:i,set:o,nib:n});this.globalHoverSet.push(o);this.globalBlockSet.push(m);i.attrs.y<0&&o.translate(0,1+i.attrs.y*-1);m.node.onmouseover=function(){p.animate({fill:q,stroke:q},200);o.animate({opacity:1},200)}.bind(this);
m.node.onmouseout=function(){p.animate({fill:l,stroke:l},200);o.animate({opacity:0},200)}}e+=this.step}.bind(this))},drawFocusHint:function(){var a=this.x_padding_left+10,b=this.options.height-this.y_padding_bottom-2.5;this.paper.path().attr({stroke:this.options.label_colour,"stroke-width":2}).moveTo(a,b).lineTo(a-5,b+5).moveTo(a-5,b).lineTo(a-10,b+5)},drawVerticalLabels:function(){var a=this.step/2,b=this.options.label_rotation?{"text-anchor":"end",rotation:this.options.label_rotation,translation:"0 "+
this.options.font_size/2}:{"text-anchor":"end"};this.drawMarkers(this.options.labels.reverse(),[0,-1],this.step,a,[-8,-(this.options.font_size/5)],b)},drawHorizontalLabels:function(){var a=this.graph_width/this.y_label_count,b=this.makeValueLabels(this.y_label_count);if(this.options.vertical_label_unit)for(var c=0;c<b.length;c++)b[c]+=this.options.vertical_label_unit;this.drawMarkers(b,[1,0],a,a,[0,(this.options.font_size+7)*-1])},drawMeanLine:function(a){var b=this.paper.path().attr(this.options.meanline);
a=$A(a).inject(0,function(c,d){return d+c})/a.length;a=this.options.bar?a+this.zero_value*(this.graph_height/this.y_label_count):a;b.moveTo(this.x_padding_left-1+a,this.y_padding_top).lineTo(this.x_padding_left-1+a,this.y_padding_top+this.graph_height)}});
...
this.normalise(this.options.acceptable_range[1]),this.options.width,this.normalise(this.options.acceptable_range[0])):(this.background=this.paper.rect(0,0,this.options.width,this.options.height));this.background.attr({fill:this.options.background_colour,stroke:"none"});this.draw()},calculateStep:function(){return this.options.width/(this.data.length-1)},makeRandomColour:function(){return Raphael.hsb2rgb(Math.random(),1,0.75).hex},normalise:function(a){a-=this.data.min()<0?this.data.min():0;return this.options.height/
