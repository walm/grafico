...
* Added various api options to edit the new functionality, such as hover color, allowing the last item of a bar chart to be a different colour (todo: make working for standard bar graph)
